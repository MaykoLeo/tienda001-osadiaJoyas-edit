...
import { PlusCircle, Pencil, Trash2, Loader2, FileDown, CheckCircle, XCircle, ChevronsUpDown, ArrowUp, ArrowDown } from 'lucide-react';
        ...
        <Card className="shadow-lg">
            <CardHeader className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                    <Button onClick={onExport} variant="outline"><FileDown className="mr-2 h-4 w-4" />Exportar a CSV</Button>
                                    ...
                                    {paginatedCoupons.map(coupon => (
                                        <TableRow key={coupon.id}>
                                            ...
                                            <TableCell><div className="flex gap-2 justify-end pr-4">
                                                <Button variant="outline" size="icon" onClick={() => onEdit(coupon)}><Pencil className="h-4 w-4" /></Button>
                                                <AlertDialog>
